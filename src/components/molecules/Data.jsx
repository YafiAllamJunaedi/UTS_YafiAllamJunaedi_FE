const Data = ({ name, age, join_date, str, type,  edit, remove }) => {
  return (
    <div className="w-full">
      <div className="w-full h-auto flex">
        <div className="w-1/5 text-center gap-y-2">
        ...
        <div className="w-1/5 text-center gap-y-2">
          <p className="">{join_date}</p>
        </div>
        <div className="w-1/5 flex justify-center gap-x-3 mt-3">
